...
/**
 * BQProductionEnvironmentandSupportServicesInitiateOutputModel
 */
public class BQProductionEnvironmentandSupportServicesInitiateOutputModel   {
  private String productionEnvironmentandSupportServicesInstanceReference = null;

  private String productionEnvironmentandSupportServicesInitiateActionReference = null;

  private Object productionEnvironmentandSupportServicesInitiateActionRecord = null;
  ...
  **/
   ...
   * @return productionEnvironmentandSupportServicesInitiateActionReference
  **/

  public String getProductionEnvironmentandSupportServicesInitiateActionReference() {
    return productionEnvironmentandSupportServicesInitiateActionReference;
  }

  public void setProductionEnvironmentandSupportServicesInitiateActionReference(String productionEnvironmentandSupportServicesInitiateActionReference) {
    this.productionEnvironmentandSupportServicesInitiateActionReference = productionEnvironmentandSupportServicesInitiateActionReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The Initiate service call input and output record 
   * @return productionEnvironmentandSupportServicesInitiateActionRecord
  **/

  public Object getProductionEnvironmentandSupportServicesInitiateActionRecord() {
    return productionEnvironmentandSupportServicesInitiateActionRecord;
  }

  public void setProductionEnvironmentandSupportServicesInitiateActionRecord(Object productionEnvironmentandSupportServicesInitiateActionRecord) {
    this.productionEnvironmentandSupportServicesInitiateActionRecord = productionEnvironmentandSupportServicesInitiateActionRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Production Environment and Support Services instance (e.g. initialised, pending, active) 
