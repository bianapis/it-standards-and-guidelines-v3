...
/**
 * BQProductTestingandDeploymentMechanismsRequestOutputModel
 */
public class BQProductTestingandDeploymentMechanismsRequestOutputModel   {
  ...
  private String productTestingandDeploymentMechanismsRequestActionTaskReference = null;

  private Object productTestingandDeploymentMechanismsRequestActionTaskRecord = null;

  private String productTestingandDeploymentMechanismsRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Product Testing and Deployment Mechanisms instance request service call 
   * @return productTestingandDeploymentMechanismsRequestActionTaskReference
  **/

  public String getProductTestingandDeploymentMechanismsRequestActionTaskReference() {
    return productTestingandDeploymentMechanismsRequestActionTaskReference;
  }

  public void setProductTestingandDeploymentMechanismsRequestActionTaskReference(String productTestingandDeploymentMechanismsRequestActionTaskReference) {
    this.productTestingandDeploymentMechanismsRequestActionTaskReference = productTestingandDeploymentMechanismsRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return productTestingandDeploymentMechanismsRequestActionTaskRecord
  **/

  public Object getProductTestingandDeploymentMechanismsRequestActionTaskRecord() {
    return productTestingandDeploymentMechanismsRequestActionTaskRecord;
  }

  public void setProductTestingandDeploymentMechanismsRequestActionTaskRecord(Object productTestingandDeploymentMechanismsRequestActionTaskRecord) {
    this.productTestingandDeploymentMechanismsRequestActionTaskRecord = productTestingandDeploymentMechanismsRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Product Testing and Deployment Mechanisms service request record 
   * @return productTestingandDeploymentMechanismsRequestRecordReference
  **/

  public String getProductTestingandDeploymentMechanismsRequestRecordReference() {
    return productTestingandDeploymentMechanismsRequestRecordReference;
  }

  public void setProductTestingandDeploymentMechanismsRequestRecordReference(String productTestingandDeploymentMechanismsRequestRecordReference) {
    this.productTestingandDeploymentMechanismsRequestRecordReference = productTestingandDeploymentMechanismsRequestRecordReference;
  }
