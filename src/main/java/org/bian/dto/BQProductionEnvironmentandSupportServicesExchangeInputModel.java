...
/**
 * BQProductionEnvironmentandSupportServicesExchangeInputModel
 */
public class BQProductionEnvironmentandSupportServicesExchangeInputModel   {
  ...
  private CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest productionEnvironmentandSupportServicesExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * Get productionEnvironmentandSupportServicesExchangeActionRequest
   * @return productionEnvironmentandSupportServicesExchangeActionRequest
  **/

  public CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest getProductionEnvironmentandSupportServicesExchangeActionRequest() {
    return productionEnvironmentandSupportServicesExchangeActionRequest;
  }

  public void setProductionEnvironmentandSupportServicesExchangeActionRequest(CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest productionEnvironmentandSupportServicesExchangeActionRequest) {
    this.productionEnvironmentandSupportServicesExchangeActionRequest = productionEnvironmentandSupportServicesExchangeActionRequest;
  }
