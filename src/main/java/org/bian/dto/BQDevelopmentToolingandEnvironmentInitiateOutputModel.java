...
/**
 * BQDevelopmentToolingandEnvironmentInitiateOutputModel
 */
public class BQDevelopmentToolingandEnvironmentInitiateOutputModel   {
  private String developmentToolingandEnvironmentInstanceReference = null;

  private String developmentToolingandEnvironmentInitiateActionReference = null;
  ...
  **/
   ...
   * @return developmentToolingandEnvironmentInitiateActionReference
  **/

  public String getDevelopmentToolingandEnvironmentInitiateActionReference() {
    return developmentToolingandEnvironmentInitiateActionReference;
  }

  public void setDevelopmentToolingandEnvironmentInitiateActionReference(String developmentToolingandEnvironmentInitiateActionReference) {
    this.developmentToolingandEnvironmentInitiateActionReference = developmentToolingandEnvironmentInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Development Tooling and Environment instance (e.g. initialised, pending, active) 
