...
/**
 * BQITPoliciesandGuidelinesRequestOutputModel
 */
public class BQITPoliciesandGuidelinesRequestOutputModel   {
  ...
  private String iTPoliciesandGuidelinesRequestActionTaskReference = null;

  private Object iTPoliciesandGuidelinesRequestActionTaskRecord = null;

  private String iTPoliciesandGuidelinesRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a ITPolicies and Guidelines instance request service call 
   * @return iTPoliciesandGuidelinesRequestActionTaskReference
  **/

  public String getITPoliciesandGuidelinesRequestActionTaskReference() {
    return iTPoliciesandGuidelinesRequestActionTaskReference;
  }

  public void setITPoliciesandGuidelinesRequestActionTaskReference(String iTPoliciesandGuidelinesRequestActionTaskReference) {
    this.iTPoliciesandGuidelinesRequestActionTaskReference = iTPoliciesandGuidelinesRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return iTPoliciesandGuidelinesRequestActionTaskRecord
  **/

  public Object getITPoliciesandGuidelinesRequestActionTaskRecord() {
    return iTPoliciesandGuidelinesRequestActionTaskRecord;
  }

  public void setITPoliciesandGuidelinesRequestActionTaskRecord(Object iTPoliciesandGuidelinesRequestActionTaskRecord) {
    this.iTPoliciesandGuidelinesRequestActionTaskRecord = iTPoliciesandGuidelinesRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the ITPolicies and Guidelines service request record 
   * @return iTPoliciesandGuidelinesRequestRecordReference
  **/

  public String getITPoliciesandGuidelinesRequestRecordReference() {
    return iTPoliciesandGuidelinesRequestRecordReference;
  }

  public void setITPoliciesandGuidelinesRequestRecordReference(String iTPoliciesandGuidelinesRequestRecordReference) {
    this.iTPoliciesandGuidelinesRequestRecordReference = iTPoliciesandGuidelinesRequestRecordReference;
  }
