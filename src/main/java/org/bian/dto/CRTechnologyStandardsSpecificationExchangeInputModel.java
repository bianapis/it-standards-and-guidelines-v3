...
/**
 * CRTechnologyStandardsSpecificationExchangeInputModel
 */
public class CRTechnologyStandardsSpecificationExchangeInputModel   {
  ...
  private CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest technologyStandardsSpecificationExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * Get technologyStandardsSpecificationExchangeActionRequest
   * @return technologyStandardsSpecificationExchangeActionRequest
  **/

  public CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest getTechnologyStandardsSpecificationExchangeActionRequest() {
    return technologyStandardsSpecificationExchangeActionRequest;
  }

  public void setTechnologyStandardsSpecificationExchangeActionRequest(CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest technologyStandardsSpecificationExchangeActionRequest) {
    this.technologyStandardsSpecificationExchangeActionRequest = technologyStandardsSpecificationExchangeActionRequest;
  }
