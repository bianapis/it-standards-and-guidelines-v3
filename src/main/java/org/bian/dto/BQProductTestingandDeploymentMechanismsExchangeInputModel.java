...
/**
 * BQProductTestingandDeploymentMechanismsExchangeInputModel
 */
public class BQProductTestingandDeploymentMechanismsExchangeInputModel   {
  ...
  private CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest productTestingandDeploymentMechanismsExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * Get productTestingandDeploymentMechanismsExchangeActionRequest
   * @return productTestingandDeploymentMechanismsExchangeActionRequest
  **/

  public CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest getProductTestingandDeploymentMechanismsExchangeActionRequest() {
    return productTestingandDeploymentMechanismsExchangeActionRequest;
  }

  public void setProductTestingandDeploymentMechanismsExchangeActionRequest(CRTechnologyStandardsSpecificationExchangeInputModelTechnologyStandardsSpecificationExchangeActionRequest productTestingandDeploymentMechanismsExchangeActionRequest) {
    this.productTestingandDeploymentMechanismsExchangeActionRequest = productTestingandDeploymentMechanismsExchangeActionRequest;
  }
